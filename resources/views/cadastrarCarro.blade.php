...
<form class="row g-3" method="post" action="{{}}">
  ...
  <div class="col-12">
    ...
    <input type="text" name="cor "class="form-control" id="inputCor" placeholder="52352-53523">
  </div>


  <div class="col-md-6">
    <label for="inputValor" class="form-label">Valor</label>
    <input type="text" name="valor "class="form-control" id="inputValor" placeholder="R$434,000">
  </div>
